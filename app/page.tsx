        ...
        <div className="grid grid-cols-1 md:grid-cols-12 h-screen items-center">
          ...
          <div className="md:col-span-6 flex flex-col justify-center items-center md:items-start h-full  p-4 md:pl-8">
            ...
            <div className="flex flex-col md:flex-row items-center gap-2 md:gap-3">
              <h1 className="text-lg md:text-1xl text-white font-bold text-center md:text-left">
                I'm Ready For Job
              </h1>
              <RotatingText
                texts={['Web Programming', 'Web Development', 'Junior Nextjs', 'Laravel Fullstack']}
                mainClassName="px-2 sm:px-2 md:px-3 bg-[#8F86D9] text-black overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-lg text-xl md:text-2xl font-bold inline-flex transition-all"
                staggerFrom={"last"}
                initial={{ y: "100%" }}
                animate={{ y: 0 }}
                exit={{ y: "-120%" }}
              ...
              <a href="mailto:irfakmaulana05@gmail.com" target="_blank" rel="noopener noreferrer">
                <button
                  className="relative z-20 px-6 py-3 bg-[#8F86D9] text-white text-lg font-semibold rounded-lg shadow-md hover:bg-[#7a72c0] transition-all duration-300"
                >
                  Contact Me
                </button>
              </a>
