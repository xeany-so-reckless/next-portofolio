...
export default function Home() {
  ...
  return (
      <div className="relative overflow-hidden">
        {/* Tombol Scroll ke Atas Selalu Muncul */}
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 bg-[#8F86D9] text-white p-3 z-40 rounded-full shadow-lg hover:bg-[#7a72c0] transition-all duration-300"
        >
          ↑
        </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 h-screen items-center">
              ...
              <div className="md:col-span-6 flex flex-col justify-center items-center md:items-start h-full p-4 md:pl-8">
                ...
                <div className="flex flex-col md:flex-row items-center gap-2 md:gap-3">
                  ...
                  <RotatingText
                    texts={["Web Programming", "Web Development", "Junior Next.js", "Laravel Fullstack"]}
